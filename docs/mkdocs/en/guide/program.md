...
run, pass the Program to [`compile_to_sc`][fatqat.compiler.compile_to_sc] or
[`compile_to_na`][fatqat.compiler.compile_to_na]. The
[compiler workflow](compiler.md) describes supported gates and source restrictions.
